...
class BreezWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        ...
        fun updateWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
            ioScope.launch {
                val views = runCatching {
                    ...
                    RemoteViews(context.packageName, R.layout.breez_widget).apply {
                        setTextViewText(
                            R.id.widget_empty,
                            context.getString(R.string.widget_preview_empty)
                        )
                    }
                }
        ...
        private suspend fun buildRemoteViews(context: Context, appWidgetId: Int): RemoteViews {
            ...
            val clickIntent = Intent(context, BreezWidgetReceiver::class.java).apply {
